...
from Box2D import (b2World, b2ContactListener, b2Body, b2Fixture, b2FixtureDef, b2Shape, b2CircleShape, b2PolygonShape,
                   b2Joint, b2RayCastCallback, b2Vec2, b2Mat22, b2Transform, b2_staticBody, b2_dynamicBody, b2AABB,
...
class Module:
    ...
    # called when new bodies spawn in the group (they wont yet be in the group.bodies)
...
# utility type to pack Box2D body definitions
default_density = 1
